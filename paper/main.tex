...
\begin{abstract}
  ...
  representation collapse by normalizing, quantizing, and bounding the
  latent representation. Our method is straightforward, compatible
  with any model-free RL algorithm, and demonstrates state-of-the-art
