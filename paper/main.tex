...
\begin{tikzpicture}
  ...
  % Minimization
  \node[blue!50,below of=z1,align=center,font=\scriptsize,xshift=4em] (min) {minimize: $\|\bar\vz_{\bullet}-\hat\vz_{\bullet}\|$};
...
\end{tikzpicture}
\caption{Self-predictice loss We denote our normalization scheme by \cube.}
